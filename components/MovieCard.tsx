...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
  return (
    <div className="group bg-zinc-900 col-span-1 relative h-[12vw] ">
      <img
        className=" cursor-pointer object-cover transition duration-0 shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-ful h-[12vw]"
      ...
      <div
        className=" 
      opacity-0 absolute 
      top-0 transition duration-200 z-10 
